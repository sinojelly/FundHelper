...
class FundWorkbook(object):
    def __init__(self, file):
        ...
        self.sheet = {FUND_SHEET_NAME: FundSheet(self.wb), STOCK_SHEET_NAME: StockIndexSheet(self.wb)}  # 注意不是原始wb 中的Sheet，而是这里的FundSheet包装类对象
        self.sheet_alias = {FUND_SHEET_NAME: 'fund', STOCK_SHEET_NAME: 'stock'}  # 使用英文别名，便于在javascript中直接访问
        self.alias_to_sheet = {}
